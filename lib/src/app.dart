...
class Config {
  /// 主题颜色
  static const int _primaryColorValue = 0xff00c498;
  static const Color primaryColor = Color(_primaryColorValue);
  static const MaterialColor primarySwatchColor = MaterialColor(
    _primaryColorValue,
    <int, Color>{
      50: Color(0xFFadff2f),
      100: Color(0xFF7fff00),
      200: Color(0xFF7cfc00),
      300: Color(0xFF00ff00),
      400: Color(0xFF00fa9a),
      500: Color(_primaryColorValue),
      600: Color(0xFF228b22),
      700: Color(0xFF008000),
      800: Color(0xFF006400),
      900: Color(0xff156148),
    },
  );
